...
- **This release has huge changes to how commands are invoked. The old
  ...
  support will be removed entirely** See [the documentation](README.md) for
  more details. There are also some [docs on upgrading from previous
  versions](docs/upgrade-from-0.3.0-to-0.4.0.md).
