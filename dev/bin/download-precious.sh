#!/bin/sh
set -e
# Code generated by godownloader on 2019-08-25T14:50:07Z. DO NOT EDIT.
#
# DOH, I edited it to fix the binary name. The naming scheme for OS & arch I'm
# using with Rust doesn't match what goreleaser/godownloader.

usage() {
  this=$1
  cat <<EOF

$this: download binaries for houseabsolute/precious
...
NAME=${BINARY}-v${VERSION}-x86_64-unknown-linux-gnu
